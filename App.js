            ...
            <NavigationContainer>
                ...
                >
                    <Tab.Screen name="Map">{({navigation, route}) => {
                        return <HomeScreen trace_db={this.state.trace_db}
                                           route={(route.params !== undefined) ? route.params.route : undefined}/>
                    }}</Tab.Screen>
                    <Tab.Screen name="Roads" component={Roads}/>
                    <Tab.Screen name="Organisation">{() => <OrganisationScreen
                        organisation_db={this.state.organisation_db}/>}</Tab.Screen>
                </Tab.Navigator>
            </NavigationContainer>
        );
    }
